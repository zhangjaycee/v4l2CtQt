...
*/
{
    ...
    float inradsq = _rInner*_rInner; //in radius square?
    float outradsq = _rOuter*_rOuter;//out radius square?
    ...
    float prob = ((float)(_maxSampleNum))/(maxrow-minrow+1)/(maxcol-mincol+1);//probability?
